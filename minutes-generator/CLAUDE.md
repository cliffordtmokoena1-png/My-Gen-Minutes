MinutesGenerator is a service that allows users to upload audio or video files, and produces a transcript and meeting minutes downloadable as a Word document. Users can also upload Word, text and image files, and generate minutes from them too.
